...
| 1.6 Visual spot-check | 🔴 TODO | Not done as a formal deliverable (5+5 overlays saved to Drive), though the 1.5 investigation informally spot-checked one Kaggle image (`470_3200_640.jpg` — confirmed real valve symbols + pipe tags visible, consistent with the label data). |
